...
import { handlePullRequest, handleReviewComment, handleIssueComment } from './handlers/pull-request.js';
...
export function registerWebhookHandlers(webhooks: Webhooks, bus: IEventBus): void {
  ...
  webhooks.on('issue_comment', (event) => handleIssueComment(event, bus));
